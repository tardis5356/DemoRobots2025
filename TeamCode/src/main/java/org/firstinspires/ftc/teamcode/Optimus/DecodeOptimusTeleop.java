...
@TeleOp(name = "DecodeOptimusTeleop")

public class DecodeOptimusTeleop extends CommandOpMode {
    ...
    public static double ARM_INDEX_POSITION = 3750, ARM_LOWER_LIMIT = 4000, ARM_UPPER_LIMIT = 0;
